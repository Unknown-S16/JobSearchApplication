        ...
        {filteredItems.length > 0 ? (
          filteredItems.map((item) => {
            ...
            return (
              ...
              >
                <div className="w-20 h-20 rounded-lg bg-gradient-to-b border border-white from-white to-gray-300 shadow-[0px_0px_10px_rgba(0,0,0,0.1)] flex items-center justify-center">
                  <img
                    src={item.imageUrl || `/images/img${randomIndex}.png`}
                    alt="CompanyLogo"
                ...
                <p className="text-gray-500 text-sm flex items-center">
                  ...
                  <button className="bg-blue-400 hover:bg-blue-500 w-full p-3 text-white rounded-lg">Apply Now</button>
              </div>
            );
          })
        ) : (
